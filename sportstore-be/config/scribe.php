...
return [
    ...
    'title' => 'SportStore API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Tài liệu tích hợp API cho dự án SportStore - Hệ thống bán lẻ Thể thao.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            Chào mừng bạn đến với tài liệu API của SportStore.
            ...
            <aside>Các đoạn code ví dụ (bash, javascript...) nằm ở bên sáng bên phải để bạn có thể tham khảo nhanh.</aside>
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Sử dụng Bearer Token lấy từ API login để xác thực.',
    ],
    ...
    'groups' => [
        ...
        'order' => [
            '1. Đăng ký & Đăng nhập',
            '2. Sản phẩm & Danh mục (Khách hàng)',
            '3. Giỏ hàng & Thanh toán',
            '4. Thông tin cá nhân & Địa chỉ',
            '5. AI Chatbot (Gemini)',
